          ...
          <form className="mt-3 space-y-3 sm:mt-0">
            ...
            <div className="border-y border-skin-border bg-skin-block-bg text-base md:rounded-xl md:border">
              <div className="group flex h-[57px] justify-between rounded-t-none border-b border-skin-border px-4 pb-[12px] pt-3 md:rounded-t-lg">
                <h4 className="flex items-center" style={{ color: "white" }}>
                  Profile
                </h4>
                  ...
                  <div className="flex flex-col-reverse sm:flex-row">
                    <div className="mt-3 w-full space-y-2 sm:mt-0">
                      ...
                      <div className="w-full">
                        ...
                        <div className="flex">
                          <div className="group relative z-10 flex w-full">
                            <input
                              type="text"
                              className="tune-input px-3 py-2 cursor-not-allowed w-full"
                      ...
                      <div>
                        ...
                        <textarea
                          className="tune-textarea w-full disabled"
                          ...
                          <div className="flex">
                            <div className="group relative z-10 flex w-full">
                              <div className="absolute inset-y-0 left-0 flex items-center pl-3">
                                ...
                                <select className="!pl-[40px] tune-input px-3 py-2 cursor-not-allowed w-full" style={{ maxWidth: "100%" }}>
                                    <option>Select Categorie(s)</option>
                                </select>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="w-full">
                        ...
                        <div className="flex">
                          <div className="group relative z-10 flex w-full">
                            ...
                            <input
                              className="!pl-[40px] tune-input px-3 py-2 cursor-not-allowed w-full"
                              type="text"
