...
function MyApp({ Component, pageProps }: AppProps) {
  return (
    <ConnectionProvider endpoint={endpoint}>
      ...
      <>
        <div id="content" className="pb-6 pt-4"><div><div className="relative">
          ...
          <div className="px-0 md:px-4 mx-auto max-w-[1012px]"><div className="grid gap-4 md:grid-cols-3 lg:grid-cols-4">
